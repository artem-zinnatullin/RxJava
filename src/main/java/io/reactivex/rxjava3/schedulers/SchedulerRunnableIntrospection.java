 ...
 * <p>
 * You can check if a {@link Runnable} task submitted to a {@link Scheduler Scheduler} (or its
 * {@link Scheduler.Worker Scheduler.Worker}) implements this interface and unwrap the
