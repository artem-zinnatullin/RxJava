 ...
 *     </td>
 *     <td>{@link io.reactivex.rxjava3.Observable Observable}</td>
 *     <td>{@link io.reactivex.rxjava3.Observer Observer}</td>
 * </tr>
 * <tr>
 *     <td>{@link io.reactivex.rxjava3.subjects.SingleSubject SingleSubject}</td>
 *     <td>{@link io.reactivex.rxjava3.Single Single}</td>
 *     <td>{@link io.reactivex.rxjava3.SingleObserver SingleObserver}</td>
 * </tr>
 * <tr>
 *     <td>{@link io.reactivex.rxjava3.subjects.MaybeSubject MaybeSubject}</td>
 *     <td>{@link io.reactivex.rxjava3.Maybe Maybe}</td>
 *     <td>{@link io.reactivex.rxjava3.MaybeObserver MaybeObserver}</td>
 * </tr>
 * <tr>
 *     <td>{@link io.reactivex.rxjava3.subjects.CompletableSubject CompletableSubject}</td>
 *     <td>{@link io.reactivex.rxjava3.Completable Completable}</td>
 *     <td>{@link io.reactivex.rxjava3.CompletableObserver CompletableObserver}</td>
 * </tr>
 * </table>
 * <p>
 * The backpressure-aware variants of the {@code Subject} class are called
 * {@link org.reactivestreams.Processor}s and reside in the {@code io.reactivex.rxjava3.processors} package.
