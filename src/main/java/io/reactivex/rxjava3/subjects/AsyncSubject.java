 ...
 * <p>
 * Since an {@code AsyncSubject} is an {@link Observable}, it does not support backpressure.
 * <p>
 ...
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code AsyncSubject} does not operate by default on a particular {@link Scheduler} and
